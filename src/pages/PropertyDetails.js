        ...
        <div className="flex flex-col items-start gap-8 lg:flex-row">
          ...
          <div className="flex-1 bg-white w-full mb-8 border border-gray-300 rounded-lg px-6 py-8">
            ...
            <form className="flex flex-col gap-y-4">
              ...
              />
              <textarea
                className="border border-gray-300 focus:border-violet-700 w-full outline-none rounded p-4 h-36 text-sm text-gray-400"
                placeholder="Message"
              ...
              <div className="flex gap-x-2">
                ...
                <button className="border border-violet-700 text-violet-700 w-full hover:border-violet-500 hover:text-violet-500 text-sm p-4 rounded">
                  Call
                </button>
              </div>
            </form>
